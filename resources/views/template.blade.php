  ...
  <div id="fh5co-page">
    ...
    <aside id="fh5co-aside" role="complementary" class="border js-fullheight">
      ...
      <nav id="fh5co-main-menu" role="navigation">
        <ul>
          <li class="{{ URL::current() == route('home') ? 'fh5co-active' : '' }}"><a
              href="{{ route('home') }}">Accueil</a>
          </li>
          <li class="{{ URL::current() == route('citations') ? 'fh5co-active' : '' }}"><a
              href="{{ route('citations') }}">Citations</a></li>
          <li class="{{ URL::current() == route('musiques') ? 'fh5co-active' : '' }}"><a
              href="{{ route('musiques') }}">Musiques</a></li>
          <li class="{{ URL::current() == route('videos') ? 'fh5co-active' : '' }}"><a
              href="{{ route('videos') }}">Clips
              Vidéos</a></li>
          <!--<li class="{{ URL::current() == route('patner') ? 'fh5co-active' : '' }}"><a href="{{ route('patner') }}">Partenaires</a></li>-->
          <li class="{{ URL::current() == route('contact') ? 'fh5co-active' : '' }}"><a
              href="{{ route('contact') }}">Contacter</a></li>
        </ul>
      </nav>

      <div class="fh5co-footer">
        <p><small>&copy; {{ date('Y') }} All Rights Reserved.</span></p>
        <ul>
